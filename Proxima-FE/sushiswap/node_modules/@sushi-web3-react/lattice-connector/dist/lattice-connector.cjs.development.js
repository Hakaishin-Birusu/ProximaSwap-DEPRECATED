...
var abstractConnector = require('@sushi-web3-react/abstract-connector');
...
var LatticeConnector = /*#__PURE__*/function (_AbstractConnector) {
  ...
  _proto.activate = /*#__PURE__*/function () {
    var _activate = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtimeModule.mark(function _callee() {
      var LatticeKeyring, engine, opts;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 3;
              return new Promise(function (resolve) { resolve(_interopNamespace(require('eth-lattice-keyring'))); }).then(function (m) {
                var _m$default;
  ...
  _proto.close = /*#__PURE__*/function () {
    var _close = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtimeModule.mark(function _callee5() {
      var CLOSE_CODE;
      return runtimeModule.wrap(function _callee5$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              this.emitDeactivate(); // Due to limitations in the LatticeSubprovider API, we use this code with `getAccounts`
              ...
              CLOSE_CODE = -1000;
              return _context5.abrupt("return", this.provider._providers[0].getAccountsAsync(CLOSE_CODE).then(function (accounts) {
                return accounts[0];
              }));
